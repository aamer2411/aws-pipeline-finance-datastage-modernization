# AWS DataStage Modernization — Vanguard IIG

Migration of IBM DataStage batch ETL pipelines to AWS for Vanguard's Institutional Investor Group (IIG). Over 110 PySpark Glue jobs replace legacy DataStage sequences, with a fully event-driven orchestration layer built on S3, Lambda, Step Functions, and Redshift.
...
![Glue Job Parameters](screenshots/glue_job_parameters_configuration.png)
...
![IPORT Dependent Job Flow](screenshots/iport_dependent_job_execution_flow.png)
...
SELECT COUNT(*) FROM iportadm.table_name@idmsat10.vanguard.com;

-- Difference check (records in Oracle 10 missing from Oracle 20)
SELECT * FROM iportadm.table_name@idmsat10.vanguard.com
MINUS
...
![Jira Kanban Board](screenshots/jira_kanban_board.png)
...
- End-to-end ETL modernization of a Tier 1 financial system from IBM DataStage to AWS Glue
