...
AWS Glue ETL scripts and supporting orchestration code for the DataStage modernization project. Scripts are organized into two sub-folders matching the two application pipelines: `Non-Iport/` and `Iport/`.
