...
#
# S3 Source Bucket : institutional-eng-us-east-1-brn-etl-s3-source/BRN_IN/
# S3 Target Bucket : institutional-eng-us-east-1-brn-etl-s3-source/TLM_OUT/
...
# Log job start in Eastern Time — consistent with US East Coast operational time zone.
