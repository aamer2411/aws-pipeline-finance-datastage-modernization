...
#
# S3 Target Bucket   : vgi-institutional-eng-us-east-1-brn-etl-s3-source
# S3 Target Folder   : Intermediate/
# KMS Key (prod)     : arn:aws:kms:us-east-1:192891038817:key/0538d146-e1ea-4e81-a68c-7579686fc95c
#
...
#   URL    : jdbc:oracle:thin:@ldap://oidprd40.vanguard.com:3060/brpprd20_all,...
#   Driver : oracle.jdbc.OracleDriver
#   Note   : LDAP-based JDBC URL — Oracle connection is resolved via LDAP directory
#            (oidprd40.vanguard.com), not a direct host:port/SID connection
################################################################################
...
try:
    ...
    target = args['targetbucketname']    # e.g., 'vgi-institutional-eng-us-east-1-brn-etl-s3-source'
    ...
    # This is Vanguard's standard Oracle production connection mechanism —
    # avoids hardcoding host:port/SID and allows transparent DB failover.
    jdbc_url         = (
        "jdbc:oracle:thin:@ldap://oidprd40.vanguard.com:3060/"
        "brpprd20_all,cn=OracleContext,dc=vanguard,dc=com"
    )
    ...
    # SSEKMSKeyId: prod KMS key ARN (arn:aws:kms:us-east-1:192891038817:key/0538d146...)
    #
    ...
    s3_client.upload_file(
        ...
        ExtraArgs={
            ...
            "SSEKMSKeyId": "arn:aws:kms:us-east-1:192891038817:key/0538d146-e1ea-4e81-a68c-7579686fc95c"
        }
    )
