...
#
# S3 Source Bucket : vgi-institutional-prod-us-east-1-brn-etl-s3-source/BRN_IN/
# S3 Target Bucket : vgi-institutional-prod-us-east-1-brn-etl-s3-source/TLM_OUT/
...
jdbc_url         = env_config["jdbc_url"]          # e.g., jdbc:db2://db2cdp03.vanguard.com:5237/...
...
class config:
    ...
    DSJobName                   = 'CUST_0062_VG_SHR_VISTA_EX_ERR' # Original DataStage job name (reference only)
...
# Using pytz timezone ensures correct DST handling for the Vanguard East Coast environment.
