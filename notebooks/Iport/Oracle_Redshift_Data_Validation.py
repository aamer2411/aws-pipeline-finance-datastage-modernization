...
def fetch_oracle_records(tab_name):
    ...
    oracle_username = "UX199061"
    oracle_password = "Monday28"
    oracle_dsn      = "//dcisoexa3-scan.vanguard.com:1521/idmprd10_all.vanguard.com"
...
def fetch_redshift_records(tab_name):
    ...
    """
    # ⚠️  Replace hard-coded credentials with Secrets Manager or env vars for production
    redshift_host     = "rsdrep04.192891038817.us-east-1.redshift-serverless.amazonaws.com"
    redshift_port     = 5439
    redshift_dbname   = "rsdrep04"
    redshift_username = "rdre01p"
    redshift_password = "fy0uAuJu"
